...
import "./Servicos.css"; // Arquivo de estilo que criaremos abaixo
  ...
  return (
    <div className="servicos-container">
      ...
      <section className="secao-individuais">
        ...
        <p className="titulo-secao">Escolha o serviço que melhor atende às suas necessidades:</p>
        ...
        <div className="oficinas-container-destaque">
          ...
          <div className="oficinas-footer-botao">
              <a 
                href="https://wa.me/5591999999999" // <-- Substitua pelo seu número correto
                target="_blank" 
            ...
            <div className="pacote-cronograma">
              ...
              <ul>
                ...
                <li><strong>12 Meses:</strong> 12 Drenagens + 12 Peles Sensibilizadas + 12 Terapias Integrativas + 6 Consultas.</li>
                  ...
                  <div className="pacote-footer-botao">
                     <div className="pacote-footer-botao">
