...
import "./Header.css"; // <-- ADICIONE ESTA LINHA AQUI
    ...
    return (
        <header className="header">
            ...
            <nav className="header-nav">
                ...
                {/* NOVO: ÍCONE DE CARRINHO DE COMPRAS */}
            <li className="menu-item-carrinho">
              <a href="#" className="carrinho-link" onClick={(e) => e.preventDefault()}>
                ...
                {/* Opcional: Contador de itens no carrinho (começando em 0 ou 1) */}
